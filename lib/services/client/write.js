...
function writeAttributes(objectUri, resourceId, query, callback) {
    logger.debug(context, 'writeAttributes', objectUri, resourceId, query);
...
function write(objectUri, resourceId, payload, handler, callback) {
    logger.debug(context, 'write', objectUri, resourceId, payload);
    async.waterfall([
...
function handleWrite(req, res, handler) {
    logger.debug(context, 'handleWrite', req, res);
