...
var coapRouter = require('./services/coapRouter'),
    ...
    queuedRequests = require('./services/server/queuedRequests'),
...
function start(serverConfig, startCallback) {
    ...
    if (config.getConfig().logLevel) {
        logops.setLevel(config.getConfig().logLevel);
    }

    logger.info(context, 'Starting Lightweight M2M Server %d', 222);
    ...
    exports.getDeviceByName = registry.getByName;
    exports.getDeviceById = registry.get;
...
exports.listObserversByDeviceId = informationReporting.listByDeviceId;
exports.cleanObservers = informationReporting.clean;
exports.cleanObserversByDeviceId = informationReporting.cleanByDeviceId;
...
exports.listQueuedRequests = queuedRequests.list;
